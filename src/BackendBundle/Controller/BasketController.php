...
class BasketController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $baskets = $em->getRepository('BackendBundle:Basket')->findAll();
    ...
    {
        $basket = new Basket();
        $form = $this->createForm('BackendBundle\Form\BasketType', $basket);
    ...
    {
        $deleteForm = $this->createDeleteForm($basket);
        $editForm = $this->createForm('BackendBundle\Form\BasketType', $basket);
